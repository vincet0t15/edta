...
import documentPriorities from '@/routes/document-priorities';
import type {
    DocumentPriority,
    DocumentPriorityCreateRequest,
} from '@/types/document-priority';
...
export function EditDocumentPriorityDialog({
    isOpen,
    onClose,
    priority,
}: EditDocumentPriorityDialogProps) {
    const { data, setData, put, reset, errors, processing } =
        useForm<DocumentPriorityCreateRequest>({
            code: priority.code,
    ...
    const onSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        put(documentPriorities.update(priority.id).url, {
                ...
                <form onSubmit={onSubmit}>
                    <DialogHeader className="mb-4">
                        ...
                        <DialogDescription className="text-xs">
                            Update the document priority details by providing
