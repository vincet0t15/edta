...
export function CreateDocumentPriorityDialog({
    isOpen,
    onClose,
}: CreateDocumentPriorityDialogProps) {
    ...
    const onSubmit: SubmitEventHandler = (e) => {
        e.preventDefault();
        post(documentPriorities.store().url, {
                ...
                <form onSubmit={onSubmit}>
                    <DialogHeader className="mb-4">
                        ...
                        <DialogDescription className="text-xs">
                            Add a new document priority by providing the
