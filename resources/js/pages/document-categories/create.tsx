...
export function CreateDocumentCategoryDialog({
    isOpen,
    onClose,
}: CreateDocumentCategoryDialogProps) {
    ...
    const onSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        post(documentCategories.store().url, {
                ...
                <form onSubmit={onSubmit}>
                    <DialogHeader className="mb-4">
                        ...
                        <DialogDescription className="text-xs">
                            Add a new document category by providing the
