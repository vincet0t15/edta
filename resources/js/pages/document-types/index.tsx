...
import { DeleteDocumentType } from './delete';
...
export default function DocumentTypesIndex({
    ...
    const handleSearchKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
        if (e.key === 'Enter') {
            ...
            router.get('document-types.index', queryString, {
                preserveState: true,
                preserveScroll: true,
            });
        }
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <Heading
                    ...
                    description="Overview and maintenance of all document type entries."
                />
